 ...
 *  Feel free to modify as per permission, but keep credit to Michael.
 */
...
void Snake() {
  ...
  fade(0.975*fadePercent); //Leave a trail behind the dot.
...
void Paintball() {
  ...
  if ((millis() / 1000.0) - timeBump > avgTime * 2.0) fade(0.99*fadePercent);
